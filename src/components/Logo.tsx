...
export default function Logo({ className = "", size = 64 }: LogoProps) {
  return (
    <div 
      className={`relative inline-flex items-center justify-center select-none overflow-hidden rounded-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] border border-white/20 backdrop-blur-xl ${className}`}
      style={{ 
        width: size, 
        height: size,
        background: "linear-gradient(135deg, rgba(0,210,255,0.2) 0%, rgba(0,112,243,0.3) 50%, rgba(16,185,129,0.2) 100%), #0a0a0f" 
      }}
    >
      <svg 
        viewBox="0 0 200 200" 
